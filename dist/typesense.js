...
/* harmony import */ var _Conversations__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./Conversations */ "./src/Typesense/Conversations.ts");
/* harmony import */ var _Conversation__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./Conversation */ "./src/Typesense/Conversation.ts");
...
var Client = /*#__PURE__*/function () {
  function Client(options) {
    ...
    this._conversations = new _Conversations__WEBPACK_IMPORTED_MODULE_20__["default"](this.apiCall);
    ...
    value: function conversations(id) {
      if (id === undefined) {
        ...
        if (this.individualConversations[id] === undefined) {
          this.individualConversations[id] = new _Conversation__WEBPACK_IMPORTED_MODULE_21__["default"](id, this.apiCall);
        }
