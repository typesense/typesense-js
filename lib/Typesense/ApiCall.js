...
(function (factory) {
    ...
    class ApiCall {
        ...
        performRequest(requestType, endpoint, { queryParameters = null, bodyParameters = null, additionalHeaders = {}, abortSignal = null, responseType = null }) {
            var _a, _b, _c;
            return __awaiter(this, void 0, void 0, function* () {
                ...
                for (let numTries = 1; numTries <= this.numRetriesPerRequest + 1; numTries++) {
                    ...
                    try {
                        ...
                        let response = yield (0, axios_1.default)(requestOptions);
                        ...
                        yield this.timer(this.retryIntervalSeconds);
                    }
                    finally {
